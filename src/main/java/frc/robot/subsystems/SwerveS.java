...
public class SwerveS extends SubsystemBase {
    SwerveDriveKinematics m_kinematics = new SwerveDriveKinematics(SwerveConstants.moduleLocationFrontLeft,
    ...
    SwerveModule frontLeftModule = new SwerveModule(SwerveConstants.frontLeftTurnID, SwerveConstants.frontLeftDriveID,
            SwerveConstants.frontLeftEncoderID, SwerveConstants.frontLeftOffsetRadians, bus);
    SwerveModule frontRightModule = new SwerveModule(SwerveConstants.frontRightTurnID,
            SwerveConstants.frontRightDriveID, SwerveConstants.frontRightEncoderID,
            SwerveConstants.frontRightOffsetRadians, bus);
    SwerveModule backLeftModule = new SwerveModule(SwerveConstants.backLeftTurnID, SwerveConstants.backLeftDriveID,
            SwerveConstants.backLeftEncoderID, SwerveConstants.backLeftOffsetRadians, bus);
    SwerveModule backRightModule = new SwerveModule(SwerveConstants.backRightTurnID, SwerveConstants.backRightDriveID,
            SwerveConstants.backRightEncoderID, SwerveConstants.backRightOffsetRadians, bus);
    ...
    SwerveDriveOdometry m_odometry = new SwerveDriveOdometry(
            ...
            new SwerveModulePosition[] {
                    new SwerveModulePosition(frontLeftModule.getPosition(),
                            frontLeftModule.getTurnPositionRotation2D()),
                    new SwerveModulePosition(frontRightModule.getPosition(),
                            frontRightModule.getTurnPositionRotation2D()),
    ...
    public void periodic() {
        ...
        m_pose = m_odometry.update(gyroAngle,
                new SwerveModulePosition[] {
                        ...
                        new SwerveModulePosition(frontRightModule.getPosition(),
                                frontRightModule.getTurnPositionRotation2D()),
                        new SwerveModulePosition(backLeftModule.getPosition(),
                                backLeftModule.getTurnPositionRotation2D()),
                        new SwerveModulePosition(backRightModule.getPosition(),
                                backRightModule.getTurnPositionRotation2D())
                });
    ...
    public void setModuleStates(SwerveModuleState frontLeft, SwerveModuleState frontRight, SwerveModuleState backLeft,
    ...
    public void swervePathPlanner() {
        ...
        try {
            ...
            e.printStackTrace();
            config = null;
            // config = new RobotConfig(Constants.robotMassKG, 0, new
            // ModuleConfig(Constants.SwerveConstants.wheelRadius,
            // Constants.SwerveConstants.maxLinearSpeedMPS, 1000, 2, 12, 1),
            // Constants.SwerveConstants.moduleLocationFrontLeft,Constants.SwerveConstants.moduleLocationFrontRight,Constants.SwerveConstants.moduleLocationBackLeft,Constants.SwerveConstants.moduleLocationBackRight);
        }
        ...
        AutoBuilder.configure(
                ...
                (speeds) -> setSpeedFromState(speeds), // Method that will drive the robot given ROBOT RELATIVE
